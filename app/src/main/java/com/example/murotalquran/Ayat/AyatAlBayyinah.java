...
public class AyatAlBayyinah {

    public static String [] IdAlBayyinah = {"1001",
            "1002",
            "1003",
            "1004",
            "1005",
    ...
    public static String [] NoAlBayyinah = {"1",
            "2",
            "3",
            "4",
            "5",
    ...
    public static String [] ArabAlBayyinah = {"لَمْ يَكُنِ الَّذِيْنَ كَفَرُوْا مِنْ اَهْلِ الْكِتٰبِ وَالْمُشْرِكِيْنَ مُنْفَكِّيْنَ حَتّٰى تَأْتِيَهُمُ الْبَيِّنَةُۙ",
    ...
    public static String [] LatinAlBayyinah = {"lam yakunillażīna kafarụ min ahlil-kitābi wal-musyrikīna munfakkīna ḥattā ta`tiyahumul-bayyinah",
    ...
    public static String [] ArtiAlBayyinah = {"Orang-orang yang kafir dari golongan Ahli Kitab dan orang-orang musyrik tidak akan meninggalkan (agama mereka) sampai datang kepada mereka bukti yang nyata,",
